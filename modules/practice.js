const practice = (() => {
  ...
  const practiceTrialData = [
    ...
    },
    {
      ...
      winner: 1,
      justification:
        "A lower Age gives Fighter B a competitive edge in the fight.",
    },
    {
      fighterA: {
        wins: 20,
      ...
      winner: 1,
      justification:
        "Fighter A is more likely to win thanks to its higher Strikes Avoided per Minute compared to its opponent.",
    },
    {
      fighterA: {
        wins: 20,
      ...
      winner: 1,
      justification:
        "A higher Wins gives Fighter A a competitive advantage in the fight.",
    },
    {
      fighterA: {
        wins: 13,
      ...
      winner: 0,
      justification:
        "Fighter B is favored because it has a higher Strikes Avoided per Minute, indicating superior performance.",
    },
    {
      fighterA: {
        wins: 23,
      ...
      winner: 0,
      justification:
        "Fighter A is more likely to win thanks to its higher Takedown Defense compared to its opponent.",
    },
    {
      fighterA: {
        wins: 38,
    ...
    },
    {
      ...
      winner: 0,
      justification:
        "A lower Losses gives Fighter B a competitive edge in the fight.",
    },
    {
      fighterA: {
        wins: 13,
