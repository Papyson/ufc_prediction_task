  ...
  const practiceTrialData = [
    {
      ...
      winner: 1,
      justification:
        "Fighter A has superior win record and experience advantage with better striking accuracy.",
    },
    {
      fighterA: {
        wins: 8,
      ...
      aiRationale: "Strike Accuracy",
      winner: 0,
      justification:
        "Fighter B demonstrates exceptional striking accuracy and defensive capabilities.",
    },
  ];
